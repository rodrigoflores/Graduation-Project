...
popularmente de \emph{shebang}. Esta implementação foi relativamente simples: o BOINC possuia um tutorial
...
na figura \ref{diagrama-boinc-wrapper-windows}.

A implementação no Windows foi bastante difícil: existem muitos pequenos detalhes que acabam
atrapalhando um pouco. Um dos exemplos foi específicar o caminho do executáve: para o Windows acessar
um diretório específico devemos ``truncar'' os nomes de diretórios maiores que $8$ caracteres, sendo 
assim o diretório trocando o oitavo e nono caracter por \verb#~1# e desprezando os seguintes. 
...
do workunit, quando isso deveria ser acusado na submissão do workunit.
