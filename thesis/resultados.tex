...
A instalação foi concluída no laboratório CEC do IME-USP. No momento possuímos $48$ máquinas com o sistema 
...
com máquinas com o sistema Linux já presentes na grade. 


\subsection{Testes}

Para testar a grade foi criado um script na linguagem \emph{R} que apenas fazia contas sem significado 
por, aproximadamente, $100 s$. Foram criados $100$ \textit{workunits} para serem distribuídas entre as máquinas e processadas. Como
